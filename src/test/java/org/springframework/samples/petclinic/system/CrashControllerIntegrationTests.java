 ...
 */
 ...
 class CrashControllerIntegrationTests {
	 ...
	 void testTriggerExceptionJson() {
		 ...
		 // FIX: Updated the expected error message here
		 assertThat(resp.getBody()).containsEntry("message",
				 "This is a generic runtime exception. Something unexpected went wrong!");
	 ...
	 void testTriggerExceptionHtml() {
		 ...
		 // FIX: Updated the expected error message in the HTML content here
		 assertThat(resp.getBody()).containsSubsequence("<body>", "<h2>", "Something happened...", "</h2>", "<p>",
				 "This is a generic runtime exception. Something unexpected went wrong!", "</p>", "</body>");
